...
Revision ID: 1376bec8be3f
Revises: None
Create Date: 2020-09-24 11:31:50.210262

"""

# revision identifiers, used by Alembic.
revision = '1376bec8be3f'
down_revision = None
...
def upgrade():
    ...
    op.create_index('ix_stock_jmenovita_hodnota', 'stock', ['jmenovita_hodnota'], unique=False)
...
def downgrade():
    ...
    op.drop_table('users')
    op.drop_index('ix_stock_jmenovita_hodnota', table_name='stock')
